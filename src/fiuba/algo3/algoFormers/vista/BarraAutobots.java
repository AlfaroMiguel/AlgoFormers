...
public class BarraAutobots extends VBox{
	...
	private BarraAutobots(String nombreJugador, List<Algoformer> autobots){

		this.setFillWidth(true);
		this.setMinWidth(200);
		this.nombreJugador = nombreJugador;
		agregarImagenes();
		configurarBotones(autobots);
...
//		bloquearBotonCorrespondiente(botonRatchetHumanoide, botonRatchetAlterno);
	...
	public static BarraAutobots getInstance(String nombreJugador, List<Algoformer> autobots){
		if (instancia == null){
			instancia = new BarraAutobots(nombreJugador,autobots);
		}
		return instancia;
	}
	...
	public void agregarImagen(Algoformer algoformer, Button boton){
		Image imagen = ClaseImagenes.getImage(algoformer);
...
//		agregarImagen("file:img/algoformers/alterno/ratchet.png", botonRatchetAlterno);
	...
	public void configurarBotones(List<Algoformer> autobots){
